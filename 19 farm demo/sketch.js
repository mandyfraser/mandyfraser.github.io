...
function swap(x1,y1,x2,y2){
  //simple manipulation of the game board state - switch 2 adjacent tiles
...
function keyPressed(){
  if(keyCode === LEFT_ARROW){
    if(playerX > 1){
      ...
      else if(level[playerY][playerX - 1] === 1){   //chicken beside us
        if(level[playerY][playerX - 2] === 0){   //empty space beside the chicken
