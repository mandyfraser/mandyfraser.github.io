...
function draw() {
  ...
  // quad4R = constrain(quad4R,0,random(0,255)); //was 255 instead of random, worked fine
  // quad4G = constrain(quad4G,0,random(0,255));
  // quad4B = constrain(quad4B,0,random(0,255));
